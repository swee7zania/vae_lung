...
save_results_path = r"D:/aMaster/github_code/VAE_lung_lesion_BMVC/Data/VAE_RandomSearch/VAE_params.pt"
...
def train_model(nepochs, train_loader, valid_loader, test_loader, mlp_hyperparams):
    ...
    model.to(device)
    save_results_path = r"D:/aMaster/github_code/VAE_lung_lesion_BMVC/Data/VAE_RandomSearch/MLP.pt"
